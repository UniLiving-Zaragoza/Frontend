...
const AnalyticsGraphicsPage = () => {
    ...
    return (
        <div className="App">
            ...
            <div className="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-4 mb-3">
    {/* Espacio vacío para balancear el botón de comentarios en pantallas grandes */}
    <div className="d-none d-sm-block" style={{ width: "200px" }}></div>

    {/* Botón de búsqueda centrado */}
    <div className="d-flex justify-content-center flex-grow-1 mb-2 mb-sm-0">
        <Button
    ...
    {/* Botón de comentarios alineado a la derecha con margen derecho */}
    <div className="d-flex justify-content-end" style={{ width: "200px", marginRight: "20px" }}>
        <Button 
